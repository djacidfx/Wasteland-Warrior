...
*/
    ...
    event: function(ev, msg){
		...
		case 'btn_over_restart':  //button Retry
	...
	pause: function(){
		...
		if ('undefined' != typeof gameState && null != gameState) gameState.onGamePause();
        game.sound.mute = !0
    },
	resume: function(){
		console.log('gradle resume ...');
		if ('undefined' != typeof gameState && null != gameState) gameState.onGameResume();
        game.sound.mute = !1;
    },
